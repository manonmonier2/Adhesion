...
This script concatenates several result files from input directory **[metadata/raw]**, containing pupa ids and species information obtained from adhesion test software into a single file.
